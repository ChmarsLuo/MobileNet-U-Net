...
def mobilenet_encoder(input_height=224,
    ...
    x = bottleneck(x, 64, (3, 3), up_dim=16, stride=1, sq=False, nl='RE')
    d1 = x
    print('d1:', d1.shape)


    # 112,112,64 -> 56,56,128
    x = bottleneck(x, 128, (3, 3), up_dim=64, stride=2, sq=False, nl='RE')
    x = bottleneck(x, 128, (3, 3), up_dim=72, stride=1, sq=False, nl='RE')
    d2 = x
    print('d2:', d2.shape)
    ...
    # 56,56,128 -> 28,28,256
    x = bottleneck(x, 256, (5, 5), up_dim=72, stride=2, sq=True, nl='RE')
    x = bottleneck(x, 256, (5, 5), up_dim=120, stride=1, sq=True, nl='RE')
    x = bottleneck(x, 256, (5, 5), up_dim=120, stride=1, sq=True, nl='RE')
    d3 = x
    print('d3:', d3.shape)

    # 28,28,256 -> 14,14,512
    x = bottleneck(x, 500, (3, 3), up_dim=240, stride=2, sq=False, nl='HS')
    x = bottleneck(x, 500, (3, 3), up_dim=200, stride=1, sq=False, nl='HS')
    x = bottleneck(x, 500, (3, 3), up_dim=184, stride=1, sq=False, nl='HS')
    x = bottleneck(x, 500, (3, 3), up_dim=184, stride=1, sq=False, nl='HS')
    # 14,14,500 -> 14,14,512
    x = bottleneck(x, 512, (3, 3), up_dim=480, stride=1, sq=True, nl='HS')
    x = bottleneck(x, 512, (3, 3), up_dim=672, stride=1, sq=True, nl='HS')
    d4 = x
    print('d4:', d4.shape)
    ...
    # 14,14,512 -> 7,7,1024
    x = bottleneck(x, 1024, (5, 5), up_dim=672, stride=2, sq=True, nl='HS')
    x = bottleneck(x, 1024, (5, 5), up_dim=960, stride=1, sq=True, nl='HS')
    x = bottleneck(x, 1024, (5, 5), up_dim=960, stride=1, sq=True, nl='HS')
    d5 = x
    print('d5:', d5.shape)
